...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_an_organization_releases_file_oapg(
        self,
...
class DeleteAnOrganizationReleasesFile(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def delete_an_organization_releases_file(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def delete_an_organization_releases_file(
        ...
        return self._delete_an_organization_releases_file_oapg(
