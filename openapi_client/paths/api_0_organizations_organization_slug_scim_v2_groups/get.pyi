...
# Query params
StartIndexSchema = schemas.IntSchema
FilterSchema = schemas.StrSchema
CountSchema = schemas.IntSchema
ExcludedAttributesSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'excludedAttributes': typing.Union[ExcludedAttributesSchema, str, ],
    },
    total=False
)
...
request_query_excluded_attributes = api_client.QueryParameter(
    name="excludedAttributes",
    style=api_client.ParameterStyle.FORM,
    schema=ExcludedAttributesSchema,
    explode=True,
)
# Path params
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["schemas", "totalResults", "itemsPerPage", "startIndex", "Resources", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["schemas", "totalResults", "itemsPerPage", "startIndex", "Resources", ], str]):
        return super().get_item_oapg(name)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_an_organizations_paginated_teams_oapg(
        self,
    ...
    def _list_an_organizations_paginated_teams_oapg(
        ...
        for parameter in (
            ...
            request_query_count,
            request_query_excluded_attributes,
        ):
...
class ListAnOrganizationsPaginatedTeams(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_an_organizations_paginated_teams(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def list_an_organizations_paginated_teams(
        ...
        return self._list_an_organizations_paginated_teams_oapg(
