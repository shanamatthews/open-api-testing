...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'member_id': typing.Union[MemberIdSchema, str, ],
    }
)
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["externalUsers", "id", "email", "name", "user", "role", "roleName", "orgRole", "orgRolesFromTeams", "pending", "expired", "flags", "dateCreated", "inviteStatus", "inviterName", "teams", "teamRoles", "invite_link", "isOnlyOwner", "roles", "orgRoleList", "teamRoleList", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["externalUsers", "id", "email", "name", "user", "role", "roleName", "orgRole", "orgRolesFromTeams", "pending", "expired", "flags", "dateCreated", "inviteStatus", "inviterName", "teams", "teamRoles", "invite_link", "isOnlyOwner", "roles", "orgRoleList", "teamRoleList", ], str]):
        return super().get_item_oapg(name)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _retrieve_an_organization_member_oapg(
        self,
...
class RetrieveAnOrganizationMember(BaseApi):
    ...
    def retrieve_an_organization_member(
        ...
        return self._retrieve_an_organization_member_oapg(
