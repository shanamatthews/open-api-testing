...
class BaseApi(api_client.Api):
    @typing.overload
    def _retrieve_the_latest_event_for_an_issue_oapg(
        self,
...
class RetrieveTheLatestEventForAnIssue(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def retrieve_the_latest_event_for_an_issue(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def retrieve_the_latest_event_for_an_issue(
        ...
        return self._retrieve_the_latest_event_for_an_issue_oapg(
