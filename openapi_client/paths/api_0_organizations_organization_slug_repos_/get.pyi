...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class items(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["dateCreated", "id", "name", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["dateCreated", "id", "name", ], str]):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_an_organizations_repositories_oapg(
        self,
...
class ListAnOrganizationsRepositories(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_an_organizations_repositories(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_an_organizations_repositories(
        ...
        return self._list_an_organizations_repositories_oapg(
