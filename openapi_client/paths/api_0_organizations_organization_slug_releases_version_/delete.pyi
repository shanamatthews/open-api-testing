...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_an_organizations_release_oapg(
        self,
...
class DeleteAnOrganizationsRelease(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def delete_an_organizations_release(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def delete_an_organizations_release(
        ...
        return self._delete_an_organizations_release_oapg(
