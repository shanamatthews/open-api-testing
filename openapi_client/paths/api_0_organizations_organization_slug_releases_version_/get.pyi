...
class BaseApi(api_client.Api):
    @typing.overload
    def _retrieve_an_organizations_releases_oapg(
        self,
...
class RetrieveAnOrganizationsReleases(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def retrieve_an_organizations_releases(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def retrieve_an_organizations_releases(
        ...
        return self._retrieve_an_organizations_releases_oapg(
