...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_a_tags_values_related_to_an_issue_oapg(
        self,
...
class ListATagsValuesRelatedToAnIssue(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_a_tags_values_related_to_an_issue(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_a_tags_values_related_to_an_issue(
        ...
        return self._list_a_tags_values_related_to_an_issue_oapg(
