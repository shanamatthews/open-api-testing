...
class SchemaForRequestBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            dateReleased = schemas.DateTimeSchema
            ...
            class commits(
                ...
                class MetaOapg:
                    ...
                    class items(
                        ...
                        @typing.overload
                        def __getitem__(self, name: typing_extensions.Literal["patch_set"]) -> MetaOapg.properties.patch_set: ...
                        ...
                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["patch_set", "repository", "author_name", "author_email", "timestamp", "message", "id", ], str]):
                            # dict_instance[name] accessor
                            return super().__getitem__(name)
                        
                        
                        @typing.overload
                        def get_item_oapg(self, name: typing_extensions.Literal["patch_set"]) -> typing.Union[MetaOapg.properties.patch_set, schemas.Unset]: ...
                        ...
                        def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["patch_set", "repository", "author_name", "author_email", "timestamp", "message", "id", ], str]):
                            return super().get_item_oapg(name)
                        ...
                        def __new__(
                            cls,
                            *_args: typing.Union[dict, frozendict.frozendict, ],
                            patch_set: typing.Union[MetaOapg.properties.patch_set, list, tuple, schemas.Unset] = schemas.unset,
                    ...
                    class items(
                        ...
                        class MetaOapg:
                            ...
                            class properties:
                                ...
                                previousCommit = schemas.StrSchema
                                __annotations__ = {
                                    "repository": repository,
                                    "commit": commit,
                        ...
                        @typing.overload
                        def __getitem__(self, name: typing_extensions.Literal["previousCommit"]) -> MetaOapg.properties.previousCommit: ...
                        
                        @typing.overload
                        def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
                        
                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["repository", "commit", "previousCommit", ], str]):
                            # dict_instance[name] accessor
                            return super().__getitem__(name)
                        ...
                        @typing.overload
                        def get_item_oapg(self, name: typing_extensions.Literal["previousCommit"]) -> typing.Union[MetaOapg.properties.previousCommit, schemas.Unset]: ...
                        
                        @typing.overload
                        def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
                        
                        def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["repository", "commit", "previousCommit", ], str]):
                            return super().get_item_oapg(name)
                        ...
                        def __new__(
                            ...
                            *_args: typing.Union[dict, frozendict.frozendict, ],
                            ...
                            previousCommit: typing.Union[MetaOapg.properties.previousCommit, str, schemas.Unset] = schemas.unset,
                            _configuration: typing.Optional[schemas.Configuration] = None,
                            **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
                        ) -> 'items':
                            return super().__new__(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["version", "ref", "url", "projects", "dateReleased", "commits", "refs", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["version", "ref", "url", "projects", "dateReleased", "commits", "refs", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        dateReleased: typing.Union[MetaOapg.properties.dateReleased, str, datetime, schemas.Unset] = schemas.unset,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_a_new_release_for_an_organization_oapg(
        self,
...
class CreateANewReleaseForAnOrganization(BaseApi):
    ...
    def create_a_new_release_for_an_organization(
        ...
        return self._create_a_new_release_for_an_organization_oapg(
            body=body,
