...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class event(
                ...
                class MetaOapg:
                    ...
                    class properties:
                        ...
                        class _meta(
                            ...
                            def __getitem__(self, name: typing.Union[typing_extensions.Literal["context", "contexts", "entries", "message", "packages", "sdk", "tags", "user", ], str]):
                            ...
                            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["context", "contexts", "entries", "message", "packages", "sdk", "tags", "user", ], str]):
                            ...
                            def __new__(
                                ...
                                *_args: typing.Union[dict, frozendict.frozendict, ],
                                ...
                                contexts: typing.Union[MetaOapg.properties.contexts, dict, frozendict.frozendict, None, schemas.Unset] = schemas.unset,
                        ...
                        class context(
                            ...
                            class MetaOapg:
                                ...
                                class properties:
                                    ...
                                    unauthorized = schemas.BoolSchema
                            ...
                            @typing.overload
                            def __getitem__(self, name: typing_extensions.Literal["unauthorized"]) -> MetaOapg.properties.unauthorized: ...
                            ...
                            def __getitem__(self, name: typing.Union[typing_extensions.Literal["length", "results", "session", "unauthorized", "url", ], str]):
                                # dict_instance[name] accessor
                                return super().__getitem__(name)
                            ...
                            @typing.overload
                            def get_item_oapg(self, name: typing_extensions.Literal["unauthorized"]) -> typing.Union[MetaOapg.properties.unauthorized, schemas.Unset]: ...
                            ...
                            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["length", "results", "session", "unauthorized", "url", ], str]):
                                return super().get_item_oapg(name)
                            ...
                            def __new__(
                                ...
                                *_args: typing.Union[dict, frozendict.frozendict, ],
                                ...
                                session: typing.Union[MetaOapg.properties.session, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
                                unauthorized: typing.Union[MetaOapg.properties.unauthorized, bool, schemas.Unset] = schemas.unset,
                        ...
                        class packages(
                            ...
                            class MetaOapg:
                                ...
                                class properties:
                                    my_package = schemas.StrSchema
                                    __annotations__ = {
                                        "my.package": my_package,
                                    }
                            
                            @typing.overload
                            def __getitem__(self, name: typing_extensions.Literal["my.package"]) -> MetaOapg.properties.my_package: ...
                            
                            @typing.overload
                            def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
                            
                            def __getitem__(self, name: typing.Union[typing_extensions.Literal["my.package", ], str]):
                                # dict_instance[name] accessor
                                return super().__getitem__(name)
                            
                            
                            @typing.overload
                            def get_item_oapg(self, name: typing_extensions.Literal["my.package"]) -> typing.Union[MetaOapg.properties.my_package, schemas.Unset]: ...
                            
                            @typing.overload
                            def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
                            
                            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["my.package", ], str]):
                                return super().get_item_oapg(name)
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["_meta", "context", "contexts", "dateCreated", "dateReceived", "dist", "entries", "errors", "eventID", "fingerprints", "groupID", "id", "message", "metadata", "packages", "platform", "sdk", "size", "tags", "type", "user", "title", ], str]):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["_meta", "context", "contexts", "dateCreated", "dateReceived", "dist", "entries", "errors", "eventID", "fingerprints", "groupID", "id", "message", "metadata", "packages", "platform", "sdk", "size", "tags", "type", "user", "title", ], str]):
                    return super().get_item_oapg(name)
                ...
                def __new__(
                    ...
                    *_args: typing.Union[dict, frozendict.frozendict, ],
                    ...
                    sdk: typing.Union[MetaOapg.properties.sdk, dict, frozendict.frozendict, None, ],
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["event", "eventId", "groupId", "organizationSlug", "projectSlug", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["event", "eventId", "groupId", "organizationSlug", "projectSlug", ], str]):
        return super().get_item_oapg(name)
...
class ResolveAnEventId(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def resolve_an_event_id(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def resolve_an_event_id(
        ...
        return self._resolve_an_event_id_oapg(
