...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'stat': typing.Union[StatSchema, str, ],
...
request_query_stat = api_client.QueryParameter(
    name="stat",
...
class BaseApi(api_client.Api):
    @typing.overload
    def _retrieve_event_counts_for_an_organization_oapg(
        self,
...
class RetrieveEventCountsForAnOrganization(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def retrieve_event_counts_for_an_organization(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def retrieve_event_counts_for_an_organization(
        ...
        return self._retrieve_event_counts_for_an_organization_oapg(
