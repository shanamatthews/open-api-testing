...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["avatar", "dateCreated", "hasAccess", "id", "isMember", "isPending", "memberCount", "organization", "name", "slug", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["avatar", "dateCreated", "hasAccess", "id", "isMember", "isPending", "memberCount", "organization", "name", "slug", ], str]):
        return super().get_item_oapg(name)
...
class RetrieveATeam(BaseApi):
    ...
    def retrieve_a_team(
        ...
        return self._retrieve_a_team_oapg(
