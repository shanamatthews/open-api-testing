...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["project", "name", "slug", "status", "type", "config", "alert_rule", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["project", "name", "slug", "status", "type", "config", "alert_rule", ], str]):
        return super().get_item_oapg(name)
...
class CreateAMonitor(BaseApi):
    ...
    def create_a_monitor(
        ...
        return self._create_a_monitor_oapg(
            body=body,
