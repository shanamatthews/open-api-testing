...
request_path_repo_id = api_client.PathParameter(
    name="repo_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=RepoIdSchema,
    required=True,
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class items(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["dateCreated", "id", "message", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["dateCreated", "id", "message", ], str]):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_a_repositorys_commits_oapg(
        self,
...
class ListARepositorysCommits(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_a_repositorys_commits(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_a_repositorys_commits(
        ...
        return self._list_a_repositorys_commits_oapg(
