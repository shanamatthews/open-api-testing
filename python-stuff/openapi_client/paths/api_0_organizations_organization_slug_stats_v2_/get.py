...
class FieldSchema(
    ...
    @schemas.classproperty
    def QUANTITY(cls):
        return cls("sum(quantity)")
    
    @schemas.classproperty
    def TIMES_SEEN(cls):
        return cls("sum(times_seen)")
...
class OutcomeSchema(
    ...
    @schemas.classproperty
    def CLIENT_DISCARD(cls):
        return cls("client_discard")
...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        ...
        'field': typing.Union[FieldSchema, str, ],
    }
)
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'outcome': typing.Union[OutcomeSchema, str, ],
...
request_query_outcome = api_client.QueryParameter(
    name="outcome",
    style=api_client.ParameterStyle.FORM,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _retrieve_event_counts_for_an_organization__v2_oapg(
        self,
...
class RetrieveEventCountsForAnOrganizationV2(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def retrieve_event_counts_for_an_organization__v2(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def retrieve_event_counts_for_an_organization__v2(
        ...
        return self._retrieve_event_counts_for_an_organization__v2_oapg(
