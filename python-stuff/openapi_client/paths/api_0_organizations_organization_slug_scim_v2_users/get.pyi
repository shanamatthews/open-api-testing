...
class ExcludedAttributesSchema(
    schemas.ListSchema
):
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'excludedAttributes': typing.Union[ExcludedAttributesSchema, list, tuple, ],
    },
    total=False
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_an_organizations_members_oapg(
        self,
...
class ListAnOrganizationsMembers(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_an_organizations_members(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def list_an_organizations_members(
        ...
        return self._list_an_organizations_members_oapg(
