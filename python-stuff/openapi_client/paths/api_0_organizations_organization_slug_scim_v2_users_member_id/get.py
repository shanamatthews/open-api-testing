...
class BaseApi(api_client.Api):
    @typing.overload
    def _query_an_individual_organization_member_oapg(
        self,
...
class QueryAnIndividualOrganizationMember(BaseApi):
    ...
    def query_an_individual_organization_member(
        ...
        return self._query_an_individual_organization_member_oapg(
